'''25. Construya una solución en Pseudocódigo que permita calcular y mostrar el Total a Pagar por las compras/ventas
...
• Utilizar un ciclo “Para” para realizar el proceso N veces, responder a la pregunta ¿Cuantas veces quieres realizar
el proceso?, con base a la respuesta realizar ese numero de veces el proceso.
...
#Escrituras
print("Otra tienda genérica SA de CV")
print("A partir de este punto en adelante se hará el proceso de introducir productos bajo cantidad y precio")
print("El número que inserte será el número de productos únicos a introducir")
print("Una vez ponga ese número de productos únicos se realizará el bucle hasta terminar el n° de veces")
print("Ingrese el n° de veces que se realizará el bucle")
cont=int(input())

#Ciclo entero
for m in range (1,(cont+1)):
    ...
    print(" ")
    print(" ")
    print("Presione enter para continuar con el ciclado")
    input()
